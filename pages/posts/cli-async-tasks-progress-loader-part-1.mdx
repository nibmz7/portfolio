...
export const meta = {
  ...
  title: "CLI Async Tasks Progress Loader Part 1",
  date: "2 October 2022",
};
...
If you look at the gif above, you can see the cursor at the start of the line. We can remove hide it to make it look nicer.
