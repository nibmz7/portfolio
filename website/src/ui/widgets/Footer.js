...
const template = `
    ...
    <style>
        ...
        .item:nth-of-type(2) > svg {
            height: 60%;
            width: 60%;
        }
        .item:nth-of-type(3) > svg {
            height: 80%;
            width: 80%;
        }
        .item:nth-of-type(5) > svg {
            height: 60%;
            width: 60%;
        }
    ...
    <div id="root">
        ...
        <div class="item" id="linkedin"  tabindex="0" aria-label="Open Linkedln profile">
        ...
        <div class="item" id="github" tabindex="0" aria-label="Open Github page">
        ...
        <div class="item" id="twitter" tabindex="0" aria-label="Open Twitter profile">
        ...
        <div class="item" id="devto" tabindex="0" aria-label="Open Dev.to blog">  
